...
(function dartProgram() {
  ...
  var A = {JS_CONST: function JS_CONST() {
    ...
    main() {
      var t1 = $.$get$toDoInput(),
        t2 = type$._ElementEventStreamImpl_Event;
      t2._eval$1("~(1)?")._as(A.main__addToDoItem$closure());
      type$.nullable_void_Function._as(null);
      A._EventStreamSubscription$(t1, "change", A.main__addToDoItem$closure(), false, t2._precomputed1);
    },
    addToDoItem(e) {
      var newToDo = document.createElement("li"),
        t1 = $.$get$toDoInput();
      B.LIElement_methods.set$text(newToDo, t1.value);
      B.InputElement_methods.set$value(t1, "");
      $.$get$toDoList().appendChild(newToDo);
    }
  },
  J = {
  ...
  (function inheritance() {
    ...
    _inheritMany(A.Object, [A.JS_CONST, J.Interceptor, J.ArrayIterator, A.Error, A.ListIterator, A.TypeErrorDecoder, A.NullThrownFromJavaScriptException, A._StackTrace, A.Closure, A.Rti, A._FunctionParameters, A._TimerImpl, A.AsyncError, A._FutureListener, A._Future, A._AsyncCallbackEntry, A.Stream, A.StreamSubscription, A._Zone, A.ListMixin, A.StackOverflowError, A._Exception, A.Null, A._StringStackTrace, A.StringBuffer, A.EventStreamProvider, A.ImmutableListMixin, A.FixedSizeListIterator]);
    _inheritMany(J.Interceptor, [J.JSBool, J.JSNull, J.JavaScriptObject, J.JSArray, J.JSNumber, J.JSString]);
    _inheritMany(J.JavaScriptObject, [J.LegacyJavaScriptObject, A.EventTarget, A.DomException, A.Event, A._HtmlCollection_JavaScriptObject_ListMixin]);
    ...
    _inheritMany(A.HtmlElement, [A.AnchorElement, A.AreaElement, A.FormElement, A.InputElement, A.LIElement, A.SelectElement, A.UListElement]);
